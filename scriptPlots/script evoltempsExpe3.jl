...
# --- Données partie 1 : d = 3 fixe ---
n_vals = [10, 25, 50, 75, 100]
exact_d3 = [0.1, 1.08, 12.81, 120.90, 2078.31]
est_d3   = [0.20, 0.73, 1.46, 2.45, 4.76]
#err_d3   = [0.008446, 0.006438, 0.006465, 0.007203, 0.004192]

# --- Données partie 2 : n = 25 fixe ---
d_vals = [2, 3, 4, 5]
exact_n25 = [0.12, 1.08, 26.66, 5244.63]
est_n25   = [0.74, 0.73, 0.82, 0.92]
